      ...
      <div className="p-5 rounded-2xl bg-gradient-to-r from-blue-600/10 via-pink-500/10 to-transparent border border-slate-200/80 dark:border-slate-800 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
              Sincronización activa en tiempo real • Código de pareja: <code className="font-mono text-slate-700 dark:text-slate-300">DUO-8842</code>
            </p>
          </div>
        </div>

        <button className="flex items-center gap-2 text-xs font-semibold text-slate-600 dark:text-slate-300 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 px-3.5 py-2 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-700 transition-all self-start sm:self-auto">
          <Link2 className="w-3.5 h-3.5 text-slate-400" />
          <span>Gestionar Enlace</span>
        </button>
      </div>
      ...
      <form onSubmit={handleSave} className="p-5 rounded-2xl bg-white dark:bg-[#161B22] border border-slate-200/80 dark:border-slate-800 space-y-6 shadow-xs">
          ...
          <div className="space-y-2">
            ...
            <div className="relative pt-1">
              ...
              <input
                ...
                className="w-full pl-9 pr-12 py-2 rounded-xl text-xs font-bold bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white focus:outline-hidden focus:ring-2 focus:ring-blue-500"
              />
        ...
        <div className="pt-4 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between">
          <span className="text-[11px] text-slate-400 flex items-center gap-1">
            <Sparkles className="w-3.5 h-3.5 text-amber-500" /> Los cambios se sincronizarán con tu pareja al instante
          </span>
